...
{
    public partial class rptTaxReportItemWiseO : Form
    {
        public rptTaxReportItemWiseO()
        {
            InitializeComponent();
        }
        ...
        private void GetData()
        {
            ...
            {
                procedureName = "psp_TR_INVOICE_ITW";
            }
            else if (cmbReportType.Text == "Invoice Return")
            {
                procedureName = "psp_TR_INVOICE_RETURN_ITW";
            }
            else if (cmbReportType.Text == "Invoice All")
            {
                procedureName = "psp_TR_INVOICE_ALL_ITW";
            }
            else
            {
