...
{
    public partial class rptPurchaseDepartmentSummaryReport : Form
    {
        public rptPurchaseDepartmentSummaryReport()
        {
            InitializeComponent();
        }
        ...
        private void Getdata()
        {
            ...
            {
                procedureName = "psp_REPORT_PURCHASE_DEPARTMENT_DIVISION";
            }
            else if (cmbReportType.Text == "Category")
            {
                procedureName = "psp_REPORT_PURCHASE_DEPARTMENT_CATEGORY";
            }
            else
            {
        ...
        private void rptPurchaseDepartmentSummaryReport_Load(object sender, EventArgs e)
        {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (cmbReportType.Text == "Division")
            {
                reportName = "CRrptPurchaseDepartmentDivision";
            }
            else if (cmbReportType.Text == "Category")
            {
                reportName = "CRprtPurchaseDepartmentCategory";
            }
            else
            {
            ...
            DataTable dtrpt = dtPurchase.Copy();
