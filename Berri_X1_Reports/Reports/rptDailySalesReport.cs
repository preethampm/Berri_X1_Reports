...
{
    public partial class rptDailySalesReport : Form
    {
        ...
        private void GetData()
        {
            ...
            try
            {
                ...
                sqlConnection.Open();
                SqlCommand sqlCommand = new SqlCommand("psp_REPORT_DAILY_SALES", sqlConnection);
                ...
                SqlParameter[] values =
                {
                    ...
                    new SqlParameter("@fromhour", dtpFromTime.Value.TimeOfDay),
                    new SqlParameter("@tohour", dtpToTime.Value.TimeOfDay),
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtrpt = dtDaily.Copy();

            dsReport.Tables.Add(dtrpt);

            Common_View.Reporintg.PrintReport(dsReport, "CRrptDailySales", 1, true);
        }
    }
}
