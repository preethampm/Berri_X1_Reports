...
{
    public partial class rptTaxReportInvoiceWiseI : Form
    {
        public rptTaxReportInvoiceWiseI()
        {
            InitializeComponent();
        }
        ...
        private void GetData()
        {
            ...
            {
                procedureName = "psp_TR_PURCHASE_IW";
            }
            else if (cmbReportType.Text == "Purchase Return")
            {
                procedureName = "psp_TR_PURCHASE_RETURN_IW";
            }
            else if (cmbReportType.Text == "Purchase All")
            {
                procedureName = "psp_TR_PURCHASE_IW_ALL";
            }
            else
            {
